...
import 'package:pica/services/ddc_service.dart';
...
class _VerifikasiDdcPageState extends State<VerifikasiDdcPage> {
  final nkkController = TextEditingController(text: '');
  ...
  upload() async {
    ...
    response = await verifikasiDdc(
        nkk: nkkController.text,
        keterangan: ketController.text,
        latitude: fixlatitude!,
        longitude: fixlongitude!,
        foto: foto);
